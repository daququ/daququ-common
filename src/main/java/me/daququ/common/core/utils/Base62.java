...
public final class Base62 {
	  ...
	  static final int BASE = baseDigits.length();
	  static final char[] digitsChar = baseDigits.toCharArray();
	  static final int FAST_SIZE = 'z';
	  static final int[] digitsIndex = new int[FAST_SIZE + 1];
	...
	public static String encode(long number) {
	  ...
	  static int getIndex(String s, int pos) {
		char c = s.charAt(pos);
		if (c > FAST_SIZE) {
